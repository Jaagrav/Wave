...
firebase
  ...
  .on("child_added", (s) => {
    ...
    document.querySelector(".container").innerHTML +=
      ...
      i++ +
      ")><img src='https://firebasestorage.googleapis.com/v0/b/rhythm-3ef06.appspot.com/o/" +
      s.val() +
    ...
    song.src =
      "https://firebasestorage.googleapis.com/v0/b/rhythm-3ef06.appspot.com/o/" +
      songSrcs[0] +
    ...
    document.querySelector(".player .song-thumbnail").style.background =
      "url('https://firebasestorage.googleapis.com/v0/b/rhythm-3ef06.appspot.com/o/" +
      songSrcs[0] +
...
document.querySelector(".add-button").addEventListener("click", () => {
  window.open("https://jaagrav.github.io/RhythmUploadWindow", "_blank");
});
